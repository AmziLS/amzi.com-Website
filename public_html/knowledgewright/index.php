...
<title>Amzi! inc. Knowledge Wright</title>
...
<meta name="keywords" content="knowledge, wright, knowledgewright, jigs, Prolog, logic programming, rule engines, artificial intelligence,
...
<div id="content">
    ...
    <div id="beef">
        ...
        <!--Start content-->
        <h1>Knowledge Wright</h1>
        <hr />

<HR />

<P>Knowledge Wright is a customizable platform for creating domain-specific application development tools.  It is available as an <a href="/AmziOpenSource">open source project</a>.  Whereas the current distribution was developed for Windows, the system is made up of Java and Prolog code, so it could be implemented and run on any platform.</P>

<p><a href='docs/knowledgewright_manual.html'>Documentation</a><br/>
