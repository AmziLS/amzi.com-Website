...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- #BeginTemplate "/Templates/ar_mail.dwt" --><!-- DW6 -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<!-- #BeginEditable "doctitle" --> 
<title>ARulesXL</title>
<meta http-equiv="Refresh" content="3; URL=http://www.arulesxl.com" />
<!-- #EndEditable -->
<!-- #BeginEditable "head" -->
<!-- #EndEditable -->
  ...
  <tr>
    ...
    <td colspan="2" valign="top" bgcolor="#D1EFFF">
	  <table width="100%" height="115" border="0" cellspacing="5">
	    <!--DWLayoutTable-->
	    <tr>
	      <td width="100%" align="center" valign="middle" bgcolor="#D1EFFF"><h1><!-- #BeginEditable "Title" --> Mailing List<!-- #EndEditable --></h1></td>
        </tr>
      </table></td>
  </tr>
  <tr>
      ...
      <tr>
        <td width="100%" valign="top"><!-- #BeginEditable "Contents" --> 
                        <div align="center"> 
                          <p align="left">&nbsp;</p>
                          <p>&nbsp;</p>
                          <h2><font color="#333333"><i>Thank You!</i></font></h2>
                          <p>&nbsp;</p>
                          <h4>You will now be redirected back to our home page</h4>
                          <p>&nbsp;</p>
						  
<!-- Google Code for Signup Conversion Page -->
<script language="JavaScript" type="text/javascript">
<!--
var google_conversion_id = 1072324969;
...
<noscript>
<img height=1 width=1 border=0 src="http://www.googleadservices.com/pagead/conversion/1072324969/?value=100.0&label=Signup&script=0">
</noscript>
