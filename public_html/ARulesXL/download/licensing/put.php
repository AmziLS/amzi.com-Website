  ...
  <tr>
    ...
    <td colspan="2" valign="top" bgcolor="#D1EFFF">
	  <table width="100%" height="115" border="0" cellspacing="5">
	    <!--DWLayoutTable-->
	    <tr>
	      <td width="100%" align="center" valign="middle" bgcolor="#D1EFFF"><h1><!-- #BeginEditable "Title" --><font color="#666666">Return 
        License Key </font><!-- #EndEditable --></h1></td>
        </tr>
      </table></td>
  </tr>
  <tr>
    ...
    <td width="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
      ...
      <p>Enter the following items as displayed by the ARulesXL License Manager. </p>
      <form action="put_license.php" method="post" name="getkey_form" id="getkey_form">
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            ...
            <td><input type="text" name="licensekey" size="75" value="" />            </td>
          </tr>
          <tr> 
            <td><b> Hardware Fingerprint:</b></td>
            <td> 
              <p>
                <input type="text" name="fingerprint" size="15" maxlength="9" />
              </p>              </td>
          </tr>
          <tr>
            <td><b>Uninstall Code: </b></td>
            <td><input type="text" name="uninstallcode" size="15" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <p> 
          ...
          <input type="submit" name="Submit" value="Return License Key for Reissue" />
        </p>
        </form>
      <p>&nbsp;</p>
