...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
      ...
      <p>Type your email address 
        or sales reference number below and your current licenses will be emailed to you.</p>
      <p><b>Enter:</b></p>
      <form action="lookup_license.php" method="post" name="lookup_form" id="lookup_form">
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr> 
            <td><p><b>User's E-Mail:</b></p></td>
            <td> 
              <input type="text" name="femail" size="50" value="" />            </td>
          </tr>
          <tr>
            <td><p><b>or</b></p>              </td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td><p><b>Sales Reference Number: </b></p></td>
            <td><input type="text" name="freferencenumber" size="25" value="" /></td>
          </tr>
        </table>
        <p> 
          <input type="submit" name="Submit" value="Email License Information" />
        </p>
        <p>* If you enter an email address, all active license keys issued to that email address will be sent to that address.</p>
        <p>* If you enter a sales reference number,  all active license keys issued for that sale will be sent to the email address used at purchase time.</p>
        <p>&nbsp; </p>
      </form>
      <p>&nbsp;</p>
