...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="2" valign="top" bgcolor="#D1EFFF">
	  <table width="100%" height="115" border="0" cellspacing="5">
	    <!--DWLayoutTable-->
	    <tr>
	      <td width="100%" align="center" valign="middle" bgcolor="#D1EFFF"><h1><!-- #BeginEditable "Title" --><font color="#666666">Get 
  ...
  <tr>
    ...
    <td width="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
      ...
      <p>Enter the following items from your order email, return license key email, or as displayed by the ARulesXL License Manager. </p>
      <form action="get_license.php" method="post" name="getkey_form" id="getkey_form">
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><b>Reference Number: </b></td>
            <td><input type="text" name="reference" size="15" /></td>
          </tr>
          <tr> 
            <td><b> User Name:</b></td>
          ...
          <tr> 
            ...
            <td> 
              <input type="text" name="fingerprint" size="15" maxlength="9" />            </td>
          </tr>
          <tr> 
            <td><b> E-Mail:</b></td>
            <td> 
              <input type="text" name="email" size="75" value="" />            </td>
          </tr>
        </table>
        <p> 
